...
This project is a simple flocking simulation based on boids algorithm by Craig Reynolds. This testbed is used to tune the flocking behaviour in 2D environment and test predator evasion strategies.
